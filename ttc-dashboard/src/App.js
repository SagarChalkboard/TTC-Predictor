...
import { Clock, Train, AlertTriangle, ThermometerSun, MapPin, TrendingUp, Activity } from 'lucide-react';
...
const TTCDelayDashboard = () => {
  ...
  const stations = {
    'YU': ['FINCH', 'NORTH YORK CENTRE', 'SHEPPARD-YONGE', 'EGLINTON', 'ST CLAIR', 'ROSEDALE', 'BLOOR-YONGE', 'COLLEGE', 'DUNDAS', 'QUEEN', 'KING', 'UNION'],
    'BD': ['KIPLING', 'ISLINGTON', 'ROYAL YORK', 'JANE', 'RUNNYMEDE', 'HIGH PARK', 'KEELE', 'DUNDAS WEST', 'LANSDOWNE', 'DUFFERIN', 'CHRISTIE', 'BATHURST', 'SPADINA', 'ST GEORGE', 'BAY', 'BLOOR-YONGE', 'SHERBOURNE', 'CASTLE FRANK'],
    'SHP': ['SHEPPARD-YONGE', 'BAYVIEW', 'BESSARION', 'LESLIE', 'DON MILLS'],
    'SRT': ['KENNEDY', 'LAWRENCE EAST', 'ELLESMERE', 'MIDLAND', 'SCARBOROUGH CENTRE']
  };
  ...
  const makePrediction = async () => {
    ...
    try {
      ...
      const features = {
        ...
        is_major_station: ['UNION', 'BLOOR-YONGE', 'ST GEORGE', 'EGLINTON', 'FINCH'].includes(formData.station),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">AI-Powered Transit Delay Forecasting for Toronto</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Subway Line</label>
                  <select 
                ...
                <div className="flex items-center">
                  <input 
                    ...
                    onChange={(e) => setFormData({...formData, is_weekend: e.target.checked})}
                    className="mr-2"
                  />
                  ...
                  {prediction.error ? (
                    ...
                    <div>
                      <div className="text-center mb-3">
                        ...
                        <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getSeverityColor(prediction.severity)}`}>
                          {prediction.category}
                        </div>
                      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Rush Hour Pattern */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-bold mb-4">Rush Hour Delay Patterns</h3>
              <LineChart width={600} height={300} data={sampleData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="delays" stroke="#2563eb" strokeWidth={3} />
              </LineChart>
            </div>
                ...
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  ...
                  {example.prediction && !example.prediction.error && (
                    <div className="text-center">
                      ...
                      <div className={`inline-block px-2 py-1 rounded text-xs ${getSeverityColor(example.prediction.severity)}`}>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MAE (min)</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Optimized Random Forest</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2.15</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">0.285</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2.20</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">0.266</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Gradient Boosting</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2.21</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">0.245</td>
                    <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>Built with React, Python Flask, and scikit-learn • Data from Toronto Open Data Portal</p>
          <p>Predicting delays with ±2.15 minute accuracy across 38 TTC stations</p>
        </div>
      </div>
    </div>
  );
